...
message("ospray xeon target ${OSPRAY_XEON_TARGET}")
...
message("ADDING EMBREE COMMON: AVX/AVX2: ${TARGET_AVX}/${TARGET_AVX2}")
ADD_SUBDIRECTORY(${EMBREE_DIR}/common  embree_common)
message("ADDING EMBREE kernels: AVX/AVX2: ${TARGET_AVX}/${TARGET_AVX2}")
