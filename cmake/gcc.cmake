...
#IF(NOT GCC_VERSION)
#  EXECUTE_PROCESS(COMMAND ${GCC_EXECUTABLE} -dumpversion OUTPUT_VARIABLE GCC_OUTPUT)
...
IF (CMAKE_CXX_COMPILER_VERSION VERSION_LESS GCC_VERSION_REQUIRED_AVX)
  MESSAGE(WARNING "GCC Version was ${CMAKE_CXX_COMPILER_VERSION}.")
  SET(OSPRAY_COMPILER_SUPPORTS_AVX FALSE)
ELSE()
  SET(OSPRAY_COMPILER_SUPPORTS_AVX TRUE)
ENDIF()

IF (CMAKE_CXX_COMPILER_VERSION VERSION_LESS GCC_VERSION_REQUIRED_AVX2)
  MESSAGE(WARNING "GCC Version was ${CMAKE_CXX_COMPILER_VERSION}.")
