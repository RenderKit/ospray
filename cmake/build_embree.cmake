...
SET(OSPRAY_COMPILER_SUPPORTS_AVX2 TRUE CACHE BOOL "")
MARK_AS_ADVANCED(OSPRAY_COMPILER_SUPPORTS_AVX2)
IF (OSPRAY_ISA_AVX2 AND OSPRAY_COMPILER STREQUAL "GCC")
  ...
  IF(NOT GCC_VERSION)
    ...
    IF (GCC_VERSION VERSION_LESS GCC_VERSION_REQUIRED)
      ...
      SET(OSPRAY_COMPILER_SUPPORTS_AVX2 FALSE CACHE BOOL "GCC too old for AVX2" FORCE)
    ENDIF()
...
ELSE()
  ...
  IF (OSPRAY_ISA_AVX2 AND OSPRAY_COMPILER_SUPPORTS_AVX2)
