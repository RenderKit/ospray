...
ELSE()
  ...
  #OSPRAY_ADD_LIBRARY(ospray_embree${OSPRAY_LIB_SUFFIX} STATIC #SHARED 
  ${OSPRAY_EMBREE_SOURCES})
  #NOT ON WIN: TARGET_LINK_LIBRARIES(ospray_embree${OSPRAY_LIB_SUFFIX} pthread dl)
  SET_TARGET_PROPERTIES(ospray_embree${OSPRAY_LIB_SUFFIX} PROPERTIES DEFINE_SYMBOL "OSPRAY_EMBREE_EXPORTS")
  TARGET_LINK_LIBRARIES(ospray_embree${OSPRAY_LIB_SUFFIX} ws2_32 setupapi)
  IF (WIN32)
    SET_TARGET_PROPERTIES(ospray_embree${OSPRAY_LIB_SUFFIX} PROPERTIES LINK_FLAGS "/DEF:${OSPRAY_EMBREE_SOURCE_DIR}/kernels/xeon/embree.def")
  ENDIF()
  ...
  IF ((${OSPRAY_XEON_TARGET} STREQUAL "AVX2") OR
    ...
    SET_TARGET_PROPERTIES(ospray_embree_sse41 PROPERTIES COMPILE_DEFINITIONS "OSPRAY_EMBREE_EXPORTS")
  ...
  IF ((${OSPRAY_XEON_TARGET} STREQUAL "AVX2") OR
    ...
    SET_TARGET_PROPERTIES(ospray_embree_sse42 PROPERTIES COMPILE_DEFINITIONS "OSPRAY_EMBREE_EXPORTS")
  ...
  IF ((${OSPRAY_XEON_TARGET} STREQUAL "AVX2") OR
    ...
    SET_TARGET_PROPERTIES(ospray_embree_avx PROPERTIES COMPILE_DEFINITIONS "OSPRAY_EMBREE_EXPORTS")
