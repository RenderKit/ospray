...
ELSE() # Linux specific settings
  ...
  ELSE()
    ...
    IF(${OSPRAY_TASKING_SYSTEM} STREQUAL "TBB")
      SET(OSPLIB_REQS "${OSPLIB_REQS}, tbb >= ${TBB_VERSION_REQUIRED}")
    ENDIF()
    ...
    ELSE()
      ...
      IF(${OSPRAY_TASKING_SYSTEM} STREQUAL "TBB")
        SET(CPACK_RPM_devel_PACKAGE_REQUIRES "${CPACK_RPM_devel_PACKAGE_REQUIRES}, tbb-devel >= ${TBB_VERSION_REQUIRED}")
      ENDIF()
