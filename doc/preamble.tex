...
\IfFileExists{intel-spec.cls}{}{\definecolor{IntelElectricCobaltBlue}{RGB}{0,0,255}} % fallback to plain blue
\hypersetup{breaklinks=true,
            ...
            colorlinks=true,
            citecolor=IntelElectricCobaltBlue,
            urlcolor=IntelElectricCobaltBlue,
            linkcolor=IntelElectricCobaltBlue,
            pdfborder={0 0 0}}
