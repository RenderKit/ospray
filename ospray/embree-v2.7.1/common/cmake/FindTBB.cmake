...
ELSE ()
  ...
  ELSE()
    ...
    ELSE()
      FIND_PATH(TBB_INCLUDE_DIR tbb/task_scheduler_init.h PATHS ${TBB_ROOT}/include NO_DEFAULT_PATH)
      FIND_LIBRARY(TBB_LIBRARY libtbb.so.2 PATHS ${TBB_ROOT}/lib/intel64/gcc4.4)
      FIND_LIBRARY(TBB_LIBRARY_MALLOC libtbbmalloc.so.2 PATHS ${TBB_ROOT}/lib/intel64/gcc4.4)
    ENDIF()
  ENDIF()
