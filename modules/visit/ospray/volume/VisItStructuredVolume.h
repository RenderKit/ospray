...
namespace ospray {
  ...
  /*! \brief A VisItStructuredVolume is an abstraction for Volume subtypes
  ...
  */
  class OSPRAY_SDK_INTERFACE VisItStructuredVolume : public Volume {
  public:

    VisItStructuredVolume() = default;
    virtual ~VisItStructuredVolume() = default;
...
// Inlined member functions ///////////////////////////////////////////////////
  ...
  template<typename T>
  inline void VisItStructuredVolume::upsampleRegion(const T *source,
                                               T *out,
                                               const vec3i &regionSize,
                                               const vec3i &scaledRegionSize)
  {
