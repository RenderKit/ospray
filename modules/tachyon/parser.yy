...
texture
{
  ospray::vec3f v0($3,$4,$5);
  ospray::vec3f v1($7,$8,$9);
  ospray::vec3f v2($11,$12,$13);
  ospray::vec3f n0($15,$16,$17);
  ospray::vec3f n1($19,$20,$21);
  ospray::vec3f n2($23,$24,$25);
  ospray::tachyon::VertexArray *sva = ospray::tachyon::parserModel->getSTriVA(1);
