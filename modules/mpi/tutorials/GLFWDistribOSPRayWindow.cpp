...
GLFWDistribOSPRayWindow::GLFWDistribOSPRayWindow(const ospcommon::vec2i &windowSize,
...
OSPModel GLFWDistribOSPRayWindow::getModel()
{
  return model;
}

void GLFWDistribOSPRayWindow::setModel(OSPModel newModel)
{
  model = newModel;
...
void GLFWDistribOSPRayWindow::reshape(const ospcommon::vec2i &newWindowSize)
{
...
void GLFWDistribOSPRayWindow::motion(const ospcommon::vec2f &position)
{
