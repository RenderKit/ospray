...
-   CMake bug fix where external users of OSPRay needed CMake newer than 3.1
-   Fix incorrect propagation of tasking system flags from an OSPRay install
-   Fix inconsistency between supported environment variables and command
    line parameters passed to `ospInit()`
