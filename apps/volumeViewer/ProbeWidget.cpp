...
ProbeCoordinateWidget::ProbeCoordinateWidget(const std::string &label, osp::vec2f range) : range(range)
{
...
ProbeWidget::ProbeWidget(VolumeViewer *volumeViewer) : volumeViewer(volumeViewer), isEnabled(false)
{
  ...
  probeCoordinateWidgets.push_back(new ProbeCoordinateWidget("x", osp::vec2f(boundingBox.lower.x, boundingBox.upper.x)));
  probeCoordinateWidgets.push_back(new ProbeCoordinateWidget("y", osp::vec2f(boundingBox.lower.y, boundingBox.upper.y)));
  probeCoordinateWidgets.push_back(new ProbeCoordinateWidget("z", osp::vec2f(boundingBox.lower.z, boundingBox.upper.z)));
