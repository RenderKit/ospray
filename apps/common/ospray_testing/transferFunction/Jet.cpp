...
namespace ospray {
  namespace testing {
    ...
    OSPTransferFunction Jet::createTransferFunction(
        osp::vec2f value_range) const
    {
      ...
      transferFunctionColors.emplace_back(0       , 0, 0.562493);
      transferFunctionColors.emplace_back(0       , 0, 1       );
      transferFunctionColors.emplace_back(0       , 1, 1       );
      transferFunctionColors.emplace_back(0.500008, 1, 0.500008);
      transferFunctionColors.emplace_back(1       , 1, 0       );
      transferFunctionColors.emplace_back(1       , 0, 0       );
      transferFunctionColors.emplace_back(0.500008, 0, 0       );
