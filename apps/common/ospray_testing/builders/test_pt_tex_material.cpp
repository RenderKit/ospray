    ...
    const cpp::Texture &texR, const cpp::Texture &texRGBA) const
{
  ...
  {
    // metallic
    materials.push_back(cpp::Material(rendererType, "principled"));
  ...
  {
    // roughness
    materials.push_back(cpp::Material(rendererType, "carPaint"));
  ...
  {
    // kd
    materials.push_back(cpp::Material(rendererType, "obj"));
    ...
    // roughness
    materials.push_back(cpp::Material(rendererType, "metal"));
