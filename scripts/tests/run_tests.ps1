...
if ( $testMultiDevice ) {
  ...
  ospTestSuite.exe --osp:load-modules=multidevice --osp:device=multidevice --gtest_output=xml:tests-mpi.xml --baseline-dir=regression_test_baseline\ --failed-dir=failed-multidevice
