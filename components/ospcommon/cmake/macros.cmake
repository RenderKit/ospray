...
MACRO(OSPRAY_CONFIGURE_ISPC_ISA)
  ...
  SET(OSPRAY_EMBREE_ENABLE_SSE4   TRUE)
...
# Same as OSPRAY_CREATE_LIBRARY(), but sets EXCLUDE_FROM_ALL as TRUE

MACRO(OSPRAY_CREATE_OPTIONAL_LIBRARY LIBRARY_NAME)
  OSPRAY_SPLIT_CREATE_ARGS(LIBRARY ${ARGN})
...
# Same as OSPRAY_CREATE_APPLICATION(), but sets EXCLUDE_FROM_ALL as TRUE

MACRO(OSPRAY_CREATE_OPTIONAL_APPLICATION APP_NAME)
  OSPRAY_SPLIT_CREATE_ARGS(APP ${ARGN})
